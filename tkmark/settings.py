"""
Django settings for tkmark project.
...
SECRET_KEY = 'django-insecure-tl7i!hu*(!zjhr0^+z#rptua3s!_0!l4k%#i@g*mikilm0l0n2'
...
WSGI_APPLICATION = 'tkmark.wsgi.application'
...
# INSERT EMAIL SERVICE INFORMATION HERE {
# 
# 
# }
